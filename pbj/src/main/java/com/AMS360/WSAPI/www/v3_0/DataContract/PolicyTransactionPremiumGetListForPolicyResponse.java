/**
 * PolicyTransactionPremiumGetListForPolicyResponse.java
 *
...
public class PolicyTransactionPremiumGetListForPolicyResponse  implements java.io.Serializable {
    private com.AMS360.WSAPI.www.v3_0.DataContract.PolicyTransactionPremium[] policyTransactionPremium;

    public PolicyTransactionPremiumGetListForPolicyResponse() {
    }
    ...
    /**
     * Gets the policyTransactionPremium value for this PolicyTransactionPremiumGetListForPolicyResponse.
     * 
    ...
    /**
     * Sets the policyTransactionPremium value for this PolicyTransactionPremiumGetListForPolicyResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PolicyTransactionPremiumGetListForPolicyResponse)) return false;
        PolicyTransactionPremiumGetListForPolicyResponse other = (PolicyTransactionPremiumGetListForPolicyResponse) obj;
        ...
        _equals = true && 
            ((this.policyTransactionPremium==null && other.getPolicyTransactionPremium()==null) || 
             (this.policyTransactionPremium!=null &&
              java.util.Arrays.equals(this.policyTransactionPremium, other.getPolicyTransactionPremium())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getPolicyTransactionPremium() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getPolicyTransactionPremium());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getPolicyTransactionPremium(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PolicyTransactionPremiumGetListForPolicyResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.WSAPI.AMS360.com/v3.0/DataContract", "PolicyTransactionPremiumGetListForPolicyResponse"));
