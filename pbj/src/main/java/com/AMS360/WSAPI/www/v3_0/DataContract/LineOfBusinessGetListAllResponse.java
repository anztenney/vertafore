/**
 * LineOfBusinessGetListAllResponse.java
 *
...
public class LineOfBusinessGetListAllResponse  implements java.io.Serializable {
    private com.AMS360.WSAPI.www.v3_0.DataContract.LineOfBusinessInfo[] lineOfBusinessInfoList;

    public LineOfBusinessGetListAllResponse() {
    }
    ...
    /**
     * Gets the lineOfBusinessInfoList value for this LineOfBusinessGetListAllResponse.
     * 
    ...
    /**
     * Sets the lineOfBusinessInfoList value for this LineOfBusinessGetListAllResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof LineOfBusinessGetListAllResponse)) return false;
        LineOfBusinessGetListAllResponse other = (LineOfBusinessGetListAllResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(LineOfBusinessGetListAllResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.WSAPI.AMS360.com/v3.0/DataContract", "LineOfBusinessGetListAllResponse"));
