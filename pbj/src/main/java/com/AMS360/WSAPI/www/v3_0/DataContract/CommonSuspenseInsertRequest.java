/**
 * CommonSuspenseInsertRequest.java
 *
...
public class CommonSuspenseInsertRequest  implements java.io.Serializable {
    private com.AMS360.WSAPI.www.v3_0.DataContract.CommonSuspense commonSuspense;

    public CommonSuspenseInsertRequest() {
    }
    ...
    /**
     * Gets the commonSuspense value for this CommonSuspenseInsertRequest.
     * 
    ...
    /**
     * Sets the commonSuspense value for this CommonSuspenseInsertRequest.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CommonSuspenseInsertRequest)) return false;
        CommonSuspenseInsertRequest other = (CommonSuspenseInsertRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CommonSuspenseInsertRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.WSAPI.AMS360.com/v3.0/DataContract", "CommonSuspenseInsertRequest"));
