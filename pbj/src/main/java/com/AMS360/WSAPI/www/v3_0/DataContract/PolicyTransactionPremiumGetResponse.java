/**
 * PolicyTransactionPremiumGetResponse.java
 *
...
public class PolicyTransactionPremiumGetResponse  implements java.io.Serializable {
    private com.AMS360.WSAPI.www.v3_0.DataContract.PolicyTransactionPremium policyTransactionPremium;

    public PolicyTransactionPremiumGetResponse() {
    }
    ...
    /**
     * Gets the policyTransactionPremium value for this PolicyTransactionPremiumGetResponse.
     * 
    ...
    /**
     * Sets the policyTransactionPremium value for this PolicyTransactionPremiumGetResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PolicyTransactionPremiumGetResponse)) return false;
        PolicyTransactionPremiumGetResponse other = (PolicyTransactionPremiumGetResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PolicyTransactionPremiumGetResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.WSAPI.AMS360.com/v3.0/DataContract", "PolicyTransactionPremiumGetResponse"));
