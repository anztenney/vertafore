...
public class PolicyCorrectRequest  implements java.io.Serializable {
    private com.AMS360.WSAPI.www.v3_0.DataContract.Policy policy;

    public PolicyCorrectRequest() {
    }
    ...
    /**
     * Gets the policy value for this PolicyCorrectRequest.
     * 
     * @return policy
     */
    ...
    /**
     * Sets the policy value for this PolicyCorrectRequest.
     * 
     * @param policy
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PolicyCorrectRequest)) return false;
        PolicyCorrectRequest other = (PolicyCorrectRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PolicyCorrectRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.WSAPI.AMS360.com/v3.0/DataContract", "PolicyCorrectRequest"));
