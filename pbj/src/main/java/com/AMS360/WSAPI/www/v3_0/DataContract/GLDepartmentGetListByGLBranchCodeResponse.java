/**
 * GLDepartmentGetListByGLBranchCodeResponse.java
 *
...
public class GLDepartmentGetListByGLBranchCodeResponse  implements java.io.Serializable {
    private com.AMS360.WSAPI.www.v3_0.DataContract.GLDepartment[] GLDepartmentList;

    public GLDepartmentGetListByGLBranchCodeResponse() {
    }
    ...
    /**
     * Gets the GLDepartmentList value for this GLDepartmentGetListByGLBranchCodeResponse.
     * 
    ...
    /**
     * Sets the GLDepartmentList value for this GLDepartmentGetListByGLBranchCodeResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GLDepartmentGetListByGLBranchCodeResponse)) return false;
        GLDepartmentGetListByGLBranchCodeResponse other = (GLDepartmentGetListByGLBranchCodeResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GLDepartmentGetListByGLBranchCodeResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.WSAPI.AMS360.com/v3.0/DataContract", "GLDepartmentGetListByGLBranchCodeResponse"));
