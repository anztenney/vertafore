...
public class CommonNoteInsertResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the noteId value for this CommonNoteInsertResponse.
     * 
     * @return noteId
     */
    ...
    /**
     * Sets the noteId value for this CommonNoteInsertResponse.
     * 
     * @param noteId
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.WSAPI.AMS360.com/v3.0/DataContract", "CommonNoteInsertResponse"));
