/**
 * PolicyGetListByCustomerNumberResponse.java
 *
...
public class PolicyGetListByCustomerNumberResponse  implements java.io.Serializable {
    private com.AMS360.WSAPI.www.v3_0.DataContract.PolicyInfo[] policyInfoList;

    public PolicyGetListByCustomerNumberResponse() {
    }
    ...
    /**
     * Gets the policyInfoList value for this PolicyGetListByCustomerNumberResponse.
     * 
    ...
    /**
     * Sets the policyInfoList value for this PolicyGetListByCustomerNumberResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PolicyGetListByCustomerNumberResponse)) return false;
        PolicyGetListByCustomerNumberResponse other = (PolicyGetListByCustomerNumberResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PolicyGetListByCustomerNumberResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.WSAPI.AMS360.com/v3.0/DataContract", "PolicyGetListByCustomerNumberResponse"));
