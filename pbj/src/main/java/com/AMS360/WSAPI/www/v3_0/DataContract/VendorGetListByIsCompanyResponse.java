/**
 * VendorGetListByIsCompanyResponse.java
 *
...
public class VendorGetListByIsCompanyResponse  implements java.io.Serializable {
    private com.AMS360.WSAPI.www.v3_0.DataContract.VendorInfo[] vendorInfoList;

    public VendorGetListByIsCompanyResponse() {
    }
    ...
    /**
     * Gets the vendorInfoList value for this VendorGetListByIsCompanyResponse.
     * 
    ...
    /**
     * Sets the vendorInfoList value for this VendorGetListByIsCompanyResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof VendorGetListByIsCompanyResponse)) return false;
        VendorGetListByIsCompanyResponse other = (VendorGetListByIsCompanyResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VendorGetListByIsCompanyResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.WSAPI.AMS360.com/v3.0/DataContract", "VendorGetListByIsCompanyResponse"));
