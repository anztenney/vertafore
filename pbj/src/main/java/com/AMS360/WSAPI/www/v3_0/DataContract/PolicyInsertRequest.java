...
public class PolicyInsertRequest  implements java.io.Serializable {
    private com.AMS360.WSAPI.www.v3_0.DataContract.Policy policy;

    public PolicyInsertRequest() {
    }
    ...
    /**
     * Gets the policy value for this PolicyInsertRequest.
     * 
     * @return policy
     */
    ...
    /**
     * Sets the policy value for this PolicyInsertRequest.
     * 
     * @param policy
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PolicyInsertRequest)) return false;
        PolicyInsertRequest other = (PolicyInsertRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PolicyInsertRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.WSAPI.AMS360.com/v3.0/DataContract", "PolicyInsertRequest"));
