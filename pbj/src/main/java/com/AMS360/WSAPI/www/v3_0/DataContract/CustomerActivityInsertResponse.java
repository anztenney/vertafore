...
public class CustomerActivityInsertResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the activityId value for this CustomerActivityInsertResponse.
     * 
     * @return activityId
     */
    ...
    /**
     * Sets the activityId value for this CustomerActivityInsertResponse.
     * 
     * @param activityId
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.WSAPI.AMS360.com/v3.0/DataContract", "CustomerActivityInsertResponse"));
