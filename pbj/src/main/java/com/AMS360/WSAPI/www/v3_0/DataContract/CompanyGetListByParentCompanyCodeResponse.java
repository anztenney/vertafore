/**
 * CompanyGetListByParentCompanyCodeResponse.java
 *
...
public class CompanyGetListByParentCompanyCodeResponse  implements java.io.Serializable {
    private com.AMS360.WSAPI.www.v3_0.DataContract.CompanyInfo[] companyInfoList;

    public CompanyGetListByParentCompanyCodeResponse() {
    }
    ...
    /**
     * Gets the companyInfoList value for this CompanyGetListByParentCompanyCodeResponse.
     * 
    ...
    /**
     * Sets the companyInfoList value for this CompanyGetListByParentCompanyCodeResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CompanyGetListByParentCompanyCodeResponse)) return false;
        CompanyGetListByParentCompanyCodeResponse other = (CompanyGetListByParentCompanyCodeResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CompanyGetListByParentCompanyCodeResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.WSAPI.AMS360.com/v3.0/DataContract", "CompanyGetListByParentCompanyCodeResponse"));
