/**
 * PolicyGetListByPolicyNumberAndDateResponse.java
 *
...
public class PolicyGetListByPolicyNumberAndDateResponse  implements java.io.Serializable {
    private com.AMS360.WSAPI.www.v3_0.DataContract.PolicyInfo[] policyInfoList;

    public PolicyGetListByPolicyNumberAndDateResponse() {
    }
    ...
    /**
     * Gets the policyInfoList value for this PolicyGetListByPolicyNumberAndDateResponse.
     * 
    ...
    /**
     * Sets the policyInfoList value for this PolicyGetListByPolicyNumberAndDateResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PolicyGetListByPolicyNumberAndDateResponse)) return false;
        PolicyGetListByPolicyNumberAndDateResponse other = (PolicyGetListByPolicyNumberAndDateResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PolicyGetListByPolicyNumberAndDateResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.WSAPI.AMS360.com/v3.0/DataContract", "PolicyGetListByPolicyNumberAndDateResponse"));
