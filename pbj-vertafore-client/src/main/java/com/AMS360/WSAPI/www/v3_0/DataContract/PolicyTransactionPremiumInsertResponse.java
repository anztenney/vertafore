/**
 * PolicyTransactionPremiumInsertResponse.java
 *
...
public class PolicyTransactionPremiumInsertResponse  implements java.io.Serializable {
    private java.lang.String policyTransactionPremiumId;

    public PolicyTransactionPremiumInsertResponse() {
    }
    ...
    /**
     * Gets the policyTransactionPremiumId value for this PolicyTransactionPremiumInsertResponse.
     * 
    ...
    /**
     * Sets the policyTransactionPremiumId value for this PolicyTransactionPremiumInsertResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PolicyTransactionPremiumInsertResponse)) return false;
        PolicyTransactionPremiumInsertResponse other = (PolicyTransactionPremiumInsertResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PolicyTransactionPremiumInsertResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.WSAPI.AMS360.com/v3.0/DataContract", "PolicyTransactionPremiumInsertResponse"));
