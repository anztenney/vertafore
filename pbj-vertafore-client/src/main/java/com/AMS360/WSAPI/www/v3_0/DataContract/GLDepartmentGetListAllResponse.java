/**
 * GLDepartmentGetListAllResponse.java
 *
...
public class GLDepartmentGetListAllResponse  implements java.io.Serializable {
    private com.AMS360.WSAPI.www.v3_0.DataContract.GLDepartment[] GLDepartmentList;

    public GLDepartmentGetListAllResponse() {
    }
    ...
    /**
     * Gets the GLDepartmentList value for this GLDepartmentGetListAllResponse.
     * 
    ...
    /**
     * Sets the GLDepartmentList value for this GLDepartmentGetListAllResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GLDepartmentGetListAllResponse)) return false;
        GLDepartmentGetListAllResponse other = (GLDepartmentGetListAllResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GLDepartmentGetListAllResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.WSAPI.AMS360.com/v3.0/DataContract", "GLDepartmentGetListAllResponse"));
