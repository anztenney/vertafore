/**
 * PolicyTransactionPremiumInsertRequest.java
 *
...
public class PolicyTransactionPremiumInsertRequest  implements java.io.Serializable {
    private com.AMS360.WSAPI.www.v3_0.DataContract.PolicyTransactionPremium policyTransactionPremium;

    public PolicyTransactionPremiumInsertRequest() {
    }
    ...
    /**
     * Gets the policyTransactionPremium value for this PolicyTransactionPremiumInsertRequest.
     * 
    ...
    /**
     * Sets the policyTransactionPremium value for this PolicyTransactionPremiumInsertRequest.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PolicyTransactionPremiumInsertRequest)) return false;
        PolicyTransactionPremiumInsertRequest other = (PolicyTransactionPremiumInsertRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PolicyTransactionPremiumInsertRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.WSAPI.AMS360.com/v3.0/DataContract", "PolicyTransactionPremiumInsertRequest"));
