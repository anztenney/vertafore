/**
 * PolicyServicePersonnelGetListRequest.java
 *
...
public class PolicyServicePersonnelGetListRequest  implements java.io.Serializable {
    private java.lang.String policyId;

    private java.util.Calendar transactionEffectiveDate;

    public PolicyServicePersonnelGetListRequest() {
    }
    ...
    /**
     * Gets the policyId value for this PolicyServicePersonnelGetListRequest.
     * 
     * @return policyId
     */
    ...
    /**
     * Sets the policyId value for this PolicyServicePersonnelGetListRequest.
     * 
     * @param policyId
     */
    ...
    /**
     * Gets the transactionEffectiveDate value for this PolicyServicePersonnelGetListRequest.
     * 
    ...
    /**
     * Sets the transactionEffectiveDate value for this PolicyServicePersonnelGetListRequest.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PolicyServicePersonnelGetListRequest)) return false;
        PolicyServicePersonnelGetListRequest other = (PolicyServicePersonnelGetListRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PolicyServicePersonnelGetListRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.WSAPI.AMS360.com/v3.0/DataContract", "PolicyServicePersonnelGetListRequest"));
