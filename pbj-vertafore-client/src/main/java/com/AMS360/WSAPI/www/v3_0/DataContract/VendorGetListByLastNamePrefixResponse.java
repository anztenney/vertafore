/**
 * VendorGetListByLastNamePrefixResponse.java
 *
...
public class VendorGetListByLastNamePrefixResponse  implements java.io.Serializable {
    private com.AMS360.WSAPI.www.v3_0.DataContract.VendorInfo[] vendorInfoList;

    public VendorGetListByLastNamePrefixResponse() {
    }
    ...
    /**
     * Gets the vendorInfoList value for this VendorGetListByLastNamePrefixResponse.
     * 
    ...
    /**
     * Sets the vendorInfoList value for this VendorGetListByLastNamePrefixResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof VendorGetListByLastNamePrefixResponse)) return false;
        VendorGetListByLastNamePrefixResponse other = (VendorGetListByLastNamePrefixResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VendorGetListByLastNamePrefixResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.WSAPI.AMS360.com/v3.0/DataContract", "VendorGetListByLastNamePrefixResponse"));
