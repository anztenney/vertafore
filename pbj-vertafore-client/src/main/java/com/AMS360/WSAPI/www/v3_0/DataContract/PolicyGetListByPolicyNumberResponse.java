/**
 * PolicyGetListByPolicyNumberResponse.java
 *
...
public class PolicyGetListByPolicyNumberResponse  implements java.io.Serializable {
    private com.AMS360.WSAPI.www.v3_0.DataContract.PolicyInfo[] policyInfoList;

    public PolicyGetListByPolicyNumberResponse() {
    }
    ...
    /**
     * Gets the policyInfoList value for this PolicyGetListByPolicyNumberResponse.
     * 
    ...
    /**
     * Sets the policyInfoList value for this PolicyGetListByPolicyNumberResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PolicyGetListByPolicyNumberResponse)) return false;
        PolicyGetListByPolicyNumberResponse other = (PolicyGetListByPolicyNumberResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PolicyGetListByPolicyNumberResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.WSAPI.AMS360.com/v3.0/DataContract", "PolicyGetListByPolicyNumberResponse"));
