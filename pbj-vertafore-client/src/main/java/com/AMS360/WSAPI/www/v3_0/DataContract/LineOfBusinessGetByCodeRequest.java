/**
 * LineOfBusinessGetByCodeRequest.java
 *
...
public class LineOfBusinessGetByCodeRequest  implements java.io.Serializable {
    private java.lang.String lineOfBusinessCode;

    public LineOfBusinessGetByCodeRequest() {
    }
    ...
    /**
     * Gets the lineOfBusinessCode value for this LineOfBusinessGetByCodeRequest.
     * 
    ...
    /**
     * Sets the lineOfBusinessCode value for this LineOfBusinessGetByCodeRequest.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof LineOfBusinessGetByCodeRequest)) return false;
        LineOfBusinessGetByCodeRequest other = (LineOfBusinessGetByCodeRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(LineOfBusinessGetByCodeRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.WSAPI.AMS360.com/v3.0/DataContract", "LineOfBusinessGetByCodeRequest"));
