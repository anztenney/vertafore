/**
 * PolicyTransactionPremiumDeleteRequest.java
 *
...
public class PolicyTransactionPremiumDeleteRequest  implements java.io.Serializable {
    private java.lang.String policyTransactionPremiumId;

    public PolicyTransactionPremiumDeleteRequest() {
    }
    ...
    /**
     * Gets the policyTransactionPremiumId value for this PolicyTransactionPremiumDeleteRequest.
     * 
    ...
    /**
     * Sets the policyTransactionPremiumId value for this PolicyTransactionPremiumDeleteRequest.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PolicyTransactionPremiumDeleteRequest)) return false;
        PolicyTransactionPremiumDeleteRequest other = (PolicyTransactionPremiumDeleteRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PolicyTransactionPremiumDeleteRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.WSAPI.AMS360.com/v3.0/DataContract", "PolicyTransactionPremiumDeleteRequest"));
